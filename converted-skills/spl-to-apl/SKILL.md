...
trigger: Use when translates splunk spl queries to axiom apl. provides command mappings, function equivalents, and syntax transformations. use when migrating from splunk, converting spl queries, or learning apl equivalents of spl patterns
---
