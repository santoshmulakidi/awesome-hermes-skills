...
trigger: Use when analyzes axiom query patterns to find unused data, then builds dashboards and monitors for cost optimization. use when asked to reduce axiom costs, find unused columns or field values, identify data waste, or track ingest spend
---
