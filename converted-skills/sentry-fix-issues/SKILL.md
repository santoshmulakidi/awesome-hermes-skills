...
trigger: Use when find and fix issues from sentry using mcp. use when asked to fix sentry errors, debug production issues, investigate exceptions, or resolve bugs reported in sentry. methodically analyzes stack traces, breadcrumbs, traces, and context to identify root causes
---
