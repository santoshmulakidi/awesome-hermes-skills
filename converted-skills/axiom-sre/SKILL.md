...
trigger: Use when expert sre investigator for incidents and debugging. uses hypothesis-driven methodology and systematic triage. can query axiom observability when available. use for incident response, root cause analysis, production debugging, or log investigation
---
