...
trigger: Use when scaffolds evaluation suites for the axiom ai sdk. generates eval files, scorers, flag schemas, and config from natural-language descriptions. use when creating evals, writing scorers, setting up flag schemas, or configuring axiom.config.ts
---
