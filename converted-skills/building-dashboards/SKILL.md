...
trigger: Use when designs and builds axiom dashboards via api. covers chart types, apl and metrics/mpl query patterns, smartfilters, layout, and configuration options. use when creating dashboards, migrating from splunk, or configuring chart options
---
